/// Tailwind CSS v3.0 color palette definitions.
///
/// This library provides the complete set of Tailwind CSS v3.0 color palettes
/// as MaterialColor objects for use in Flutter applications.
///
/// Note: Colors are very similar to v3.4. Minor differences may exist.
library tailwind_v3_0_colors;

import 'package:flutter/material.dart';

/// Tailwind CSS v3.0 color palette
/// Note: Colors are very similar to v3.4. Minor differences may exist.
class TailwindV30Colors {
  // Primary values
